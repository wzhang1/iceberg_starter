python json_to_png.py --json_input train.json --output train --label_file train.lst --is_test False
python json_to_png.py --json_input test.json --output test --label_file test.lst --is_test True
python split.py 
